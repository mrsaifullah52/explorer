    ...
    <>
      {open && (
        <div className="fixed bg-black/[0.3] w-full h-full top-0 left-0 z-50">
          <div
            ref={modalRef}
            className="min-w-[400px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 my-4 p-10 bg-[#F8F9F9] dark:bg-[#393939] rounded-lg flex flex-col shadow-md z-50"
          >
